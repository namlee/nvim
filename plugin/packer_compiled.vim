...
_G.packer_plugins = {
  ["colorbuddy.vim"] = {
    loaded = true,
    path = "/Users/namle/.local/share/nvim/site/pack/packer/start/colorbuddy.vim"
  },
  ["lspkind-nvim"] = {
    loaded = true,
  ...
  onebuddy = {
    loaded = true,
    path = "/Users/namle/.local/share/nvim/site/pack/packer/start/onebuddy"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["plenary.nvim"] = {
    loaded = true,
    path = "/Users/namle/.local/share/nvim/site/pack/packer/start/plenary.nvim"
  },
  ["popup.nvim"] = {
    loaded = true,
    path = "/Users/namle/.local/share/nvim/site/pack/packer/start/popup.nvim"
  },
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/Users/namle/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
    path = "/Users/namle/.local/share/nvim/site/pack/packer/start/telescope.nvim"
  },
  ["vim-vsnip"] = {
    loaded = true,
  ...
  ["vim-which-key"] = {
    loaded = true,
    path = "/Users/namle/.local/share/nvim/site/pack/packer/start/vim-which-key"
  }
}
